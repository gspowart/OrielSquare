...
function scripts()
{
  wp_enqueue_script('main', get_theme_file_uri('/dist/main.js'), '', '1.14', true);
  wp_enqueue_script('main', get_theme_file_uri('/build/index.js'), array('jquery'), '1.14', true);
  wp_enqueue_style('main_css', get_theme_file_uri('/dist/style.css'), '', '0.14');
