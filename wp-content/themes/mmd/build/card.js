...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)("blocktheme/card", {
  title: "OS -  Card",
...
function EditComponent(props) {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps)({
    className: `row__large-4 os-card ${props.attributes.colourTheme}`
  });
