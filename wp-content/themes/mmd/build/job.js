...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)("blocktheme/job", {
  title: "OS -  Job",
  attributes: {
    text: {
      type: "string"
...
function EditComponent(props) {
  const DEFAULT_TEMPLATE = [["blocktheme/heading", {
    size: "h4",
    textColor: "headline--white",
    placeholder: "Job Title"
  }], ["core/paragraph"], ["blocktheme/button"]];
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
    className: `content-area content-area--transparent`
  });
