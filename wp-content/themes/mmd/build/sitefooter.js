...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)("blocktheme/sitefooter", {
...
function EditComponent(props) {
  //prettier-ignore
  const TEMPLATE = [["blocktheme/imagerow", {}], ["blocktheme/sitefootercontent", {}]];
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    className: `wrapper`
  });
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useInnerBlocksProps)(blockProps, {
    allowedBlocks: ["blocktheme/imagerow", "blocktheme/columncontent"],
    template: TEMPLATE
  });
